                                ...
                                >
                                    <span className="icon">
                                        <svg className='revenueSvg' width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11.0625 11.4375V13.1562C11.0625 13.6121 10.8814 14.0493 10.5591 14.3716C10.2368 14.6939 9.79959 14.875 9.34375 14.875H2.46875C2.01291 14.875 1.57574 14.6939 1.25341 14.3716C0.931082 14.0493 0.75 13.6121 0.75 13.1562V2.84375C0.75 2.38791 0.931082 1.95074 1.25341 1.62841C1.57574 1.30608 2.01291 1.125 2.46875 1.125H9C9.94918 1.125 11.0625 1.89457 11.0625 2.84375V4.5625M13.8125 11.4375L17.25 8L13.8125 4.5625M5.5625 8H16.5625" stroke="black" stroke-width="1.375" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
