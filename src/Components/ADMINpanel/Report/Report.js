...
import { getAllREPORT } from '../../Common/REDUX/ACTION/reportAction';
import { BsDot } from 'react-icons/bs';
import Pagination from '../../Common/Pagination/Pagination';
import Refresh from '../../Common/Refresh/Refresh';
import { FiAlertTriangle } from "react-icons/fi"
import { SuccessMessage } from '../../Common/Message/Message';
...
function Report() {
    ...
    const { getAllReports, isLoading } = useSelector((state) => state.reportReducer);
