...
import "./Sales.css"
import AdminSidebar from '../../Common/PanelSIDEBAR/AdminSidebar';
...
import { getAllSALES } from '../../Common/REDUX/ACTION/salesAction';
import increaseImg from "../../../Assets/Increase.svg";
import decreaseImg from "../../../Assets/decrease.svg";
import AreaChartRechart from '../../Common/RECHART/AreaChart';
import BarChartRechart from '../../Common/RECHART/BarChart';
import TableTop from '../../Common/TableTop/TableTop';
import NewMonthCalendar from '../../Common/Date/newMonth';
import GraphDate from '../../Common/Date/GraphDate';
import PercentageCard2 from '../../Common/pageCard/PercentageCard2';
import { Table, Thead, Tr, Td, Tbody } from "../../Common/Table/Table"
import NoDatafromApi from '../../Common/PAGELOADER/NoDataFromApi';
...
function Sales() {
    ...
    const { getSalesData, isLoading } = useSelector((state) => state.salesReducer);
    ...
    // if (!getSalesData) return <NoDatafromApi />;
    return (
