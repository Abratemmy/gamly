...
import { ProcessingMessage, SuccessMessage } from '../../Message/Message';

// eslint-disable-next-line no-empty-pattern
function PendingKYCDetail({ kycData, goToKyc, goToPending }) {
    ...
    return (
        <div className='kycDetails KYC pendingKYCDetail allPages'>
            <div className='container'>
                <div className='detailTop'>
                    <NavLink to={`/${goToKyc}`} className='left'>KYC</NavLink>
                    <span className='iconspan'><IoIosArrowForward className="icon" /> </span>
                    <NavLink to={`/${goToPending}`} className='left' style={{ color: '#2D3748' }}>Pending Verification</NavLink>
                    <span className='iconspan'><IoIosArrowForward className="icon" /> </span>
