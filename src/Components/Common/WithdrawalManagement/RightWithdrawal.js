...
import HostPercentage from '../pageCard/HostPercentage';
import moment from 'moment'
import ProgressBar from '../RECHART/ProgressBar';
...
function RightWithdrawal({ popupcontent, onClick }) {
    ...
    const lastMonthTotal = 5000000;
    const currentMonthTotal = 5500000;
    return (
        <div className='gameMetric_rightSidebar'>
                        ...
                        <div className='row secondrowCard'>
                            <div className='col-lg-12 col-md-12 col-sm-12' style={{ textAlign: "left" }}>
                                <div className='content' style={{ padding: "20px" }}>
                                    <div className="heading" style={{ textAlign: "left" }}>Total Withdrawal Today</div>
            ...
            <div className='rightWithdrawalProgress' style={{ padding: '0px 20px 30px 20px' }}>
                <ProgressBar lastMonthTotal={lastMonthTotal} currentMonthTotal={currentMonthTotal} progressTitle="Withdrawal Comparison" />
...
export default RightWithdrawal